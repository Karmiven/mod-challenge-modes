...
enum ChallengeModeSettings
{
    ...
    SETTING_LOW_XP_GAIN        = 4,
    SETTING_VERY_LOW_XP_GAIN   = 5,
...
public:
    ...
    std::unordered_map<std::string, std::unordered_map<uint8, uint32>*> rewardConfigMap =
    {
        ...
        { "LowXpGain.TitleRewards",              &LowXpGainTitleRewards               },
        { "VeryLowXpGain.TitleRewards",          &veryLowXpGainTitleRewards           },
        ...
        { "LowXpGain.TalentRewards",             &LowXpGainTalentRewards              },
        { "VeryLowXpGain.TalentRewards",         &veryLowXpGainTalentRewards          },
        ...
        { "LowXpGain.ItemRewards",               &LowXpGainItemRewards                },
        { "VeryLowXpGain.ItemRewards",           &veryLowXpGainItemRewards            },
        ...
        { "LowXpGain.AchievementReward",         &LowXpGainAchievementReward          },
        { "VeryLowXpGain.AchievementReward",     &veryLowXpGainAchievementReward      },
        { "QuestXpOnly.AchievementReward",        &questXpOnlyAchievementReward         },
        { "IronMan.AchievementReward",            &ironManAchievementReward             }
    };

    // Methods to retrieve challenge mode settings
    ...
    // Methods to retrieve rewards for a challenge mode
    ...
    // Get the item reward amount for a challenge mode
